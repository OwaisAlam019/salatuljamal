		...
		<div id="wrapper">
			...
			<div id="main-slider" data-interval="8000">
				<div class="slide-list">
					...
					<!-- SLIDE 2 : begin -->
					<div class="slide slide-2" data-label="20% off All Massages" style="background-image: url( '<?=base_url()?>assets/images/slide_02.jpg' );">
						<div class="slide-bg">
							<div class="container">
								<div class="slide-inner">
									<div class="slide-content various-content textalign-right valign-middle">
										...
										<h3>This Friday Only!<br><a href="<?=base_url()?>application/views/template/reservation.php" class="m-open-ajax-modal">Make a Reservation</a></h3>
