...
<div class="various-content" id="modal">
  ...
  <form id="modal-reservation-form" class="default-form m-ajax-form" action="<?=base_url()?>reservations/submit" method="post">
    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="form-field">
          ...
          <input id="reservation-email" name="reservation-email" class="m-email">
        </div>
        <!-- EMAIL FIELD : end -->
      ...
      <div class="col-sm-6">
        ...
        <div class="form-field">
          ...
          <button class="submit-btn c-button" type="submit" data-label="Send Message" data-loading-label="Sending...">Submit</button>
        </div>
        <!-- SUBMIT BUTTON : end -->
